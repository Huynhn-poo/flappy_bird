...
import { _decorator, Collider2D, Component, Node, Contact2DType, IPhysics2DContact, find, ICollisionEvent, PhysicsSystem2D } from 'cc';
...
export class ClashObject extends Component {
   ...
   protected onLoad(): void {
    ...
    onCollisionEnter(selfCollider: Collider2D, otherCollider: Collider2D, contact: IPhysics2DContact | null) {
        console.log("Collision detected between " + selfCollider.node.name + " and " + otherCollider.group);
